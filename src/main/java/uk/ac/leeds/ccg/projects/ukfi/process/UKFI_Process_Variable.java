...
public class UKFI_Process_Variable extends UKFI_Main_Process {
    ...
    public void createGraph(String name, BigDecimal yIncrement, String vName) 
         ...
         */
        TreeMap<Byte, Double> changeSubset = (TreeMap<Byte, Double>) hh.getChangeVariableSubset(
...
//        changeSubset.put((byte) 12, 47155.80562571576);
         ...
         * records.
         */
        TreeMap<Byte, Double> changeAll = (TreeMap<Byte, Double>) hh.getChangeVariableAll(vName, gors, 
                GORNameLookup);
